...
public class WorldChunkManagerCretaceous extends WorldChunkManager{
	...
	{
		this();
		GenLayer[] agenlayer = GenLayerCretaceous.makeTheWorld(seed);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}public WorldChunkManagerCretaceous(World world)
	{
