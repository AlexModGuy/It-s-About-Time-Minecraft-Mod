...
import iat.world.layer.GenLayerNowhere;
...
public class WorldChunkManagerNowhere extends WorldChunkManager
{
	...
	}public WorldChunkManagerNowhere(long seed, WorldType worldtype)
	{
		this();
		GenLayer[] agenlayer = GenLayerNowhere.makeTheWorld(seed);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}public WorldChunkManagerNowhere(World world)
	{
