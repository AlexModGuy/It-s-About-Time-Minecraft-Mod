...
public class ItemFossilBroken extends Item

{
	...
	{
		return y > 0 ? this.theIcon : super.getIconFromDamageForRenderPass(x, y);
	}
	...
	public void registerIcons(IIconRegister iconRegister)
	{
        ...
        this.theIcon = iconRegister.registerIcon("iat:overlay_Fossil");
