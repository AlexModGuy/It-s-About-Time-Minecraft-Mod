 ...
 */
public class ModelSittingVelociraptor extends MowzieModelBase {
    ...
    public ModelSittingVelociraptor() {
        ...
        this.tail1.addBox(-3.5F, -3.5F, 0.1F, 6, 6, 7, 0.0F);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) { 
		...
		tailSwing(tailParts, 0.1F, -0.05F, 2, ((EntityVelociraptor)entity).frame);
    }
