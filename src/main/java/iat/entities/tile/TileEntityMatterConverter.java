...
public class TileEntityMatterConverter extends TileEntity implements ISidedInventory
{
	...
	{
		return this.hasCustomInventoryName() ? this.name : "container.iat.matter_converter";
	}
	...
	public void updateEntity()
	{
		...
		if (!this.worldObj.isRemote)
		{
			...
			{
				flag1 = true;
				BlockMatterConverter.updateDistilleryBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
	 ...
	 private boolean canSmelt()
	{
		 ...
		 {
			 ItemStack itemstack = MatterConverterRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
