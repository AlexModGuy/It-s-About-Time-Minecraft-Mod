...
public class MowzieModelRenderer2
  extends ModelRenderer
{
  ...
  public MowzieModelRenderer2(ModelBase modelBase, String name)
  {
    super(modelBase, name);
  }
  
  public MowzieModelRenderer2(ModelBase modelBase, int x, int y)
  {
    super(modelBase, x, y);
  }
  
  public MowzieModelRenderer2(ModelBase modelBase)
  {
    super(modelBase);
  }
