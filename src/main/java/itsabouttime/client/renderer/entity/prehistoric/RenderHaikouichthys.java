...
public class RenderHaikouichthys
  extends RenderLiving
{
  private static final ResourceLocation Texture1 = new ResourceLocation( "iat:textures/entity/Haikouichthys.png");

  public RenderHaikouichthys()
  {
    super(new ModelHaikouichthys(), 0.3F);
  }
  
  protected ResourceLocation getEntityTextures(EntityHaikouichthys tr)
  {
      return Texture1;
  ...
  {
    return getEntityTextures((EntityHaikouichthys)entity);
  }
}
