...
{
  private static final ResourceLocation Texture1 = new ResourceLocation( "iat:textures/entity/Coelacanth.png");
  ...
  protected ResourceLocation getEntityTextures(EntityCoelacanth tr)
  {
      return Texture1;
  ...
  {
    return getEntityTextures((EntityCoelacanth)entity);
  }
}
