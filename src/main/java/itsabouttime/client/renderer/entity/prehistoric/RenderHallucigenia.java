...
public class RenderHallucigenia
  extends RenderLiving
{
  private static final ResourceLocation Texture1 = new ResourceLocation( "iat:textures/entity/Hallucigenia.png");

  public RenderHallucigenia()
  {
    super(new ModelHallucigenia(), 0.3F);
  }
  
  protected ResourceLocation getEntityTextures(EntityHallucigenia tr)
  {
      return Texture1;
  ...
  {
    return getEntityTextures((EntityHallucigenia)entity);
  }
}
