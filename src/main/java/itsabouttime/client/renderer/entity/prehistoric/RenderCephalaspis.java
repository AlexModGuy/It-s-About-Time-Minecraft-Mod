...
import itsabouttime.client.model.prehistoric.ModelCephalaspis;
...
public class RenderCephalaspis
  extends RenderLiving
{
  private static final ResourceLocation Texture1 = new ResourceLocation( "iat:textures/entity/Cephalaspis.png");

  public RenderCephalaspis()
  {
    super(new ModelCephalaspis(), 0.3F);
  }
  
  protected ResourceLocation getEntityTextures(EntityCephalaspis tr)
  {
      return Texture1;
  ...
  {
    return getEntityTextures((EntityCephalaspis)entity);
  }
}
