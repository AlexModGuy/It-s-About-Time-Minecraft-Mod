...
public class RenderGoldIdol extends RenderLiving
{
    private static final ResourceLocation enderDragonExplodingTextures = new ResourceLocation("iat:textures/entity/Ceolophysis/CeolophysisExploding.png");
    private static final ResourceLocation enderDragonCrystalBeamTextures = new ResourceLocation("textures/entity/endercrystal/endercrystal_beam.png");
    private static final ResourceLocation enderDragonTextures = new ResourceLocation("iat:textures/entity/Ceolophysis/StarCeolophysis.png");
    /** An instance of the dragon model in RenderDragon */
    protected ModelWaptia modelDragon;
    private static final String __OBFID = "CL_00000988";

    public RenderGoldIdol()
    {
        super(new ModelWaptia(), 0.5F);
        this.modelDragon = (ModelWaptia)this.mainModel;
        this.setRenderPassModel(this.mainModel);
    }

    protected void rotateCorpse(EntityGoldIdol p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_)
    {
     ...
     */
    protected void renderModel(EntityGoldIdol p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
     ...
     */
    public void doRender(EntityGoldIdol p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
       // BossStatus.setBossStatus(p_76986_1_, false);
        ...
        if (p_76986_1_.healingEnderCrystal != null)
        {
            ...
            for (int i = 0; i <= b0; ++i)
            {
                ...
                tessellator.setColorOpaque_I(0X0026FF);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGoldIdol p_110775_1_)
    {
        return enderDragonTextures;
    }

    protected void renderEquippedItems(EntityGoldIdol p_77029_1_, float p_77029_2_)
    {
        ...
        if (p_77029_1_.deathTicks > 0)
        {
            ...
            for (int i = 0; (float)i < (f1 + f1 * f1) / 2.0F * 60.0F; ++i)
            {
                ...
                tessellator.setColorRGBA_I(0X0026FF, (int)(255.0F * (1.0F - f2)));
                tessellator.addVertex(0.0D, 0.0D, 0.0D);
                tessellator.setColorRGBA_I(0X0026FF, 0);
     ...
     */
    protected int shouldRenderPass(EntityGoldIdol p_77032_1_, int p_77032_2_, float p_77032_3_)
    {
        if (p_77032_2_ == 1)
        {
            GL11.glDepthFunc(GL11.GL_LEQUAL);
    ...
    {
        this.doRender((EntityGoldIdol)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
    ...
    {
        return this.shouldRenderPass((EntityGoldIdol)p_77032_1_, p_77032_2_, p_77032_3_);
    }

    protected void renderEquippedItems(EntityLivingBase p_77029_1_, float p_77029_2_)
    {
        this.renderEquippedItems((EntityGoldIdol)p_77029_1_, p_77029_2_);
    }

    protected void rotateCorpse(EntityLivingBase p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_)
    {
        this.rotateCorpse((EntityGoldIdol)p_77043_1_, p_77043_2_, p_77043_3_, p_77043_4_);
    }
    ...
    {
        this.renderModel((EntityGoldIdol)p_77036_1_, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
    }
    ...
    {
        return this.getEntityTexture((EntityGoldIdol)p_110775_1_);
    }
