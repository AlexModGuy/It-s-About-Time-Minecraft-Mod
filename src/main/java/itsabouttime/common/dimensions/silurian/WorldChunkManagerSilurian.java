...
public class WorldChunkManagerSilurian extends WorldChunkManager
{
...
protected WorldChunkManagerSilurian()
{
 this.biomeCache = new BiomeCache(this);
 this.biomesToSpawnIn = new ArrayList<BiomeGenBase>();
 this.biomesToSpawnIn.add(IATbiomes.SilurianBeach);
 this.biomesToSpawnIn.add(IATbiomes.SilurianHills);
 this.biomesToSpawnIn.add(IATbiomes.SilurianRiver);
 this.biomesToSpawnIn.add(IATbiomes.SilurianSea);
}public WorldChunkManagerSilurian(long seed, WorldType worldtype)
{
this();
GenLayer[] agenlayer = GenLayerSilurian.makeTheWorld(seed);
this.genBiomes = agenlayer[0];
this.biomeIndexLayer = agenlayer[1];
}public WorldChunkManagerSilurian(World world)
{
