...
import net.minecraft.world.gen.layer.IntCache;public class WorldChunkManagerOrdovician extends WorldChunkManager
{
...
protected WorldChunkManagerOrdovician()
{
 this.biomeCache = new BiomeCache(this);
 this.biomesToSpawnIn = new ArrayList<BiomeGenBase>();
 this.biomesToSpawnIn.add(IATbiomes.OrdovicianBeach);
 this.biomesToSpawnIn.add(IATbiomes.OrdovicianHills);
 this.biomesToSpawnIn.add(IATbiomes.OrdovicianRiver);
 this.biomesToSpawnIn.add(IATbiomes.OrdovicianSea);
}public WorldChunkManagerOrdovician(long seed, WorldType worldtype)
{
this();
GenLayer[] agenlayer = GenLayerOrdovician.makeTheWorld(seed);
this.genBiomes = agenlayer[0];
this.biomeIndexLayer = agenlayer[1];
}public WorldChunkManagerOrdovician(World world)
{
