...
import net.minecraft.world.gen.layer.IntCache;public class WorldChunkManagerCambrian extends WorldChunkManager
{
...
protected WorldChunkManagerCambrian()
{
 this.biomeCache = new BiomeCache(this);
 this.biomesToSpawnIn = new ArrayList<BiomeGenBase>();
 this.biomesToSpawnIn.add(IATbiomes.CambrianBeach);
 this.biomesToSpawnIn.add(IATbiomes.CambrianHills);
 this.biomesToSpawnIn.add(IATbiomes.CambrianRiver);
 this.biomesToSpawnIn.add(IATbiomes.CambrianSea);
}public WorldChunkManagerCambrian(long seed, WorldType worldtype)
{
this();
GenLayer[] agenlayer = GenLayerCambrian.makeTheWorld(seed);
this.genBiomes = agenlayer[0];
this.biomeIndexLayer = agenlayer[1];
}public WorldChunkManagerCambrian(World world)
{
