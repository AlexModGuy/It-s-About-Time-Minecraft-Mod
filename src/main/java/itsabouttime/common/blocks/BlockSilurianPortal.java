...
public class BlockSilurianPortal extends BlockBreakable
{
...
// This is the portal class. Most of this code comes from the Vanilla Portal, so alot of it is unused, And I havn't a clue of what most of this stuff does, but it really doesn't matter because it it dead code.	
    ...
    public BlockSilurianPortal(Material glass)
    {
        super("iat:PortalSillurian", Material.portal, false);
  ...
  /*  public boolean func_150000_e(World p_150000_1_, int p_150000_2_, int p_150000_3_, int p_150000_4_)
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        BlockSilurianPortal.Size size = new BlockSilurianPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 1);
        BlockSilurianPortal.Size size1 = new BlockSilurianPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 2);

        if (l == 1 && (!size.func_150860_b() || size.field_150864_e < size.field_150868_h * size.field_150862_g))
        {
            p_149695_1_.setBlock(p_149695_2_, p_149695_3_, p_149695_4_, IATstuff.SilurianPortal);
        }
  ...
  /**  @SideOnly(Side.CLIENT)
    ...
    public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity)
    {
        ...
        MinecraftServer server = MinecraftServer.getServer();
           ...
           }else if(player.dimension != iat.dimensionIdSilurian){
        	   player.timeUntilPortal = 10;
        	   player.mcServer.getConfigurationManager().transferPlayerToDimension(player, iat.dimensionIdSilurian, new Teleporter_Prehistoric(server.worldServerForDimension(iat.dimensionIdSilurian)));
           }else{
        	   player.timeUntilPortal = 10;
           ...
           public Size(World world, int x, int y, int z, int i)
            {
                ...
                this.field_150863_d = BlockSilurianPortal.field_150001_a[i][0];
                this.field_150866_c = BlockSilurianPortal.field_150001_a[i][1];
            ...
            protected int func_150858_a()
            {
                ...
                for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
                {
                    ...
                    {
                        k = this.field_150861_f.posX + j * Direction.offsetX[BlockSilurianPortal.field_150001_a[this.field_150865_b][1]];
                        l = this.field_150861_f.posZ + j * Direction.offsetZ[BlockSilurianPortal.field_150001_a[this.field_150865_b][1]];
                        ...
                        if (block == IATstuff.SilurianPortal)
                        {
                            ++this.field_150864_e;
                        }
                        ...
                        if (j == 0)
                        {
                            block = this.field_150867_a.getBlock(k + Direction.offsetX[BlockSilurianPortal.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[BlockSilurianPortal.field_150001_a[this.field_150865_b][0]]);
                        ...
                        {
                            block = this.field_150867_a.getBlock(k + Direction.offsetX[BlockSilurianPortal.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[BlockSilurianPortal.field_150001_a[this.field_150865_b][1]]);
                ...
                {
                    j = this.field_150861_f.posX + i * Direction.offsetX[BlockSilurianPortal.field_150001_a[this.field_150865_b][1]];
                    k = this.field_150861_f.posY + this.field_150862_g;
                    l = this.field_150861_f.posZ + i * Direction.offsetZ[BlockSilurianPortal.field_150001_a[this.field_150865_b][1]];
            ...
            {
                return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == Blocks.ice || p_150857_1_ == IATstuff.SilurianPortal;
            }
