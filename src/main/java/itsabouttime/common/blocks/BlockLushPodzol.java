...
public class BlockLushPodzol extends BlockGrass 
{
    private static final Logger logger = LogManager.getLogger();
    @SideOnly(Side.CLIENT)
    private static IIcon field_149991_b;
    @SideOnly(Side.CLIENT)
        ...
        if (!p_149674_1_.isRemote)
        {
            ...
            else if (p_149674_1_.getBlockLightValue(p_149674_2_, p_149674_3_ + 1, p_149674_4_) >= 9)
            {
                for (int l = 0; l < 4; ++l)
                {
                    ...
                    {
                        p_149674_1_.setBlock(i1, j1, k1, IATstuff.LushPodzol);
                    }
                }
            }
        }
    ...
    public IIcon getIcon(IBlockAccess p_149673_1_, int p_149673_2_, int p_149673_3_, int p_149673_4_, int p_149673_5_)
    {
        if (p_149673_5_ == 1)
        {
            return BlockLushPodzol.field_149991_b;
        }
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon("iat:LushPodzolSide");
        this.field_149991_b = p_149651_1_.registerIcon("iat:LushPodzolTop");
        this.field_149993_M = p_149651_1_.registerIcon( "grass_side_snowed");
        this.field_149994_N = p_149651_1_.registerIcon("iat:LushPodzolOverlay");
    }
