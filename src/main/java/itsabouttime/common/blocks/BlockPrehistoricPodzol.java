...
public class BlockPrehistoricPodzol extends Block
{
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon("dirt_podzol_side");
        this.field_150200_a = p_149651_1_.registerIcon("dirt_podzol_top");
