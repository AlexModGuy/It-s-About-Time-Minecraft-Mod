...
public class BlockColoredEmpty extends Block{
	@SideOnly(Side.CLIENT)
private IIcon[] texture;
	final static String[] subBlocks = new String[] {"Red", "Orange", "Yellow", "Green", "Cyan", "Blue", "Purple", "Pink"};
    public static boolean fallInstantly;

	public BlockColoredEmpty() {
		super(Material.iron);
	...
	public void registerBlockIcons(IIconRegister iconregister){
		...
		for(int i = 0; i < subBlocks.length; i++){
			texture[i]=iconregister.registerIcon("iat:" +"Void_" + subBlocks[i] );
		}
	}
    ...
    private void func_149830_m(World p_149830_1_, int p_149830_2_, int p_149830_3_, int p_149830_4_)
    {
        if (func_149831_e(p_149830_1_, p_149830_2_, p_149830_3_ - 1, p_149830_4_) && p_149830_3_ >= 0)
        {
            ...
            if (!fallInstantly && p_149830_1_.checkChunksExist(p_149830_2_ - b0, p_149830_3_ - b0, p_149830_4_ - b0, p_149830_2_ + b0, p_149830_3_ + b0, p_149830_4_ + b0))
            {
                ...
                {
                    EntityRisingBlock entityfallingblock = new EntityRisingBlock(p_149830_1_, (double)((float)p_149830_2_ + 0.5F), (double)((float)p_149830_3_ + 0.5F), (double)((float)p_149830_4_ + 0.5F), this, p_149830_1_.getBlockMetadata(p_149830_2_, p_149830_3_, p_149830_4_));
    ...
    protected void func_149829_a(EntityRisingBlock p_149829_1_) {}
