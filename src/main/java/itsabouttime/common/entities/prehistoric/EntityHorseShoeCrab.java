...
import itsabouttime.common.entities.prehistoric.technical.EntityPrehistoricAnphibianCrawler;
...
public class EntityHorseShoeCrab extends EntityPehistoricAnimal implements ISmallWaterCritter{

	

	public EntityHorseShoeCrab(World par1World) {
		super(par1World);
