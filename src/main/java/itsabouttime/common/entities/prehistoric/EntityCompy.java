...
import itsabouttime.common.entities.ai.EntityAICompyAvoidEntity;
import itsabouttime.common.entities.ai.EntityAICompySit;
import itsabouttime.common.entities.ai.EntityAICompyWatchClosest;
import itsabouttime.common.entities.ai.EntityAIPrehistoricBeg;
import itsabouttime.common.entities.ai.EntityAIPrehistoricCompyBeg;
...
import itsabouttime.common.entities.ai.EntityAIPrehistoricSit;
...
public class EntityCompy extends EntityTamablePrehistoric
{
    ...
    public EntityCompy(World p_i1696_1_)
    {
        super(p_i1696_1_);
        ...
        this.tasks.addTask(8, new EntityAITempt(this, 1.2D, IATstuff.Insects, false));
        this.tasks.addTask(9, new EntityAICompyAvoidEntity(this, EntityPlayer.class, 32.0F, 0.8D, 1.33D));
        this.tasks.addTask(9, new EntityAICompyAvoidEntity(this, EntityDilophosaurus.class, 32.0F, 0.8D, 1.33D));
        this.tasks.addTask(9, new EntityAICompyAvoidEntity(this, EntityTroodon.class, 32.0F, 0.8D, 1.33D));
        this.tasks.addTask(10, new EntityAICompyWatchClosest(this, EntityPlayer.class, 8.0F));
    ...
    {
        return this.isSitting()? "mob.cat.purr" : "iat:Compy-say";
    }
    ...
    public void onUpdate()
    {
        ...
        else if ((this.isShaking || this.field_70928_h) && this.field_70928_h)
        {
            ...
            {
//Random wolf shaking code. to lazy to get rid of it
            	}
    ...
    public boolean interact(EntityPlayer p_70085_1_)
    {
        ...
        else if (itemstack != null && itemstack.getItem() instanceof ItemFood && !this.isAngry()||itemstack != null && itemstack.getItem() == IATstuff.Insects && !this.isAngry())
        {
            if (!p_70085_1_.capabilities.isCreativeMode)
            {
                --itemstack.stackSize;
    ...
    public EntityCompy createChild(EntityAgeable p_90011_1_)
    {
        EntityCompy entitywolf = new EntityCompy(this.worldObj);
    ...
    public boolean canMateWith(EntityPrehistoricMob p_70878_1_)
    {
        ...
        else if (!(p_70878_1_ instanceof EntityCompy))
        {
            return false;
        }
        ...
        {
            EntityCompy entitywolf = (EntityCompy)p_70878_1_;
    ...
    public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        ...
        {
            if (p_142018_1_ instanceof EntityCompy)
            {
                EntityCompy entitywolf = (EntityCompy)p_142018_1_;
        ...
        else
        {
            ...
            if (entity  instanceof EntityLiving && !this.isTamed())
            {
                ...
                for (int i = 0; i < list.size(); ++i)
                {
                    ...
                    if (entity1 instanceof EntityCompy)
                    {
                    	EntityCompy entitypigzombie = (EntityCompy)entity1;
