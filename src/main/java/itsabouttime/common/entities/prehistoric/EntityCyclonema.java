...
public class EntityCyclonema extends EntityPrehistoricSeaCrawler implements ISmallWaterCritter{

	

	public EntityCyclonema(World par1World) {
		super(par1World);
	 ...
	 protected void dropFewItems(boolean par1, int par2)
	  {
	      ...
	      for (int k = 0; k < j; ++k)
	      {
	         this.entityDropItem(new ItemStack(Items.slime_ball, 1 ), 0.0F);
