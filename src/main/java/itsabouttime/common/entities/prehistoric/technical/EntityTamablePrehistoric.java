...
public abstract class EntityTamablePrehistoric extends EntityPrehistoricMob implements IEntityOwnable
{
    protected EntityAIPrehistoricSit aiSit = new EntityAIPrehistoricSit(this);

    public EntityTamablePrehistoric(World p_i1604_1_)
    {
        super(p_i1604_1_);
    }
    ...
    public EntityAIPrehistoricSit func_70907_r()
    {
        return this.aiSit;
    }
