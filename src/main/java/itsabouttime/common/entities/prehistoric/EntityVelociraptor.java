...
public class EntityVelociraptor extends EntityTamablePrehistoric
{
    ...
    public EntityVelociraptor(World p_i1696_1_)
    {
        super(p_i1696_1_);
        ...
        this.tasks.addTask(8, new EntityAIPrehistoricBeg(this, 8.0F));
    ...
    {
        return this.isAngry() ? "iat:Raptor-say" : (this.rand.nextInt(3) == 0 ? (this.isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0F ? "iat:Raptor-say" : "iat:Raptor-say") : "iat:Raptor-say");
    }
    ...
    public boolean interact(EntityPlayer p_70085_1_)
    {
        ...
        else if (itemstack != null && itemstack.getItem() == Items.egg && !this.isAngry())
        {
            if (!p_70085_1_.capabilities.isCreativeMode)
            {
                --itemstack.stackSize;
    ...
    public EntityVelociraptor createChild(EntityAgeable p_90011_1_)
    {
    ...
    public boolean canMateWith(EntityPrehistoricMob p_70878_1_)
    {
        ...
        if (p_70878_1_ == this)
        {
            ...
            if( this.getType() == 0 && ((EntityVelociraptor) p_70878_1_).getType() == 1 && this.isTamed()&&  ((EntityVelociraptor) p_70878_1_).isTamed()){
            	return true;
            }if(this.getType() == 1 && ((EntityVelociraptor) p_70878_1_).getType() == 0 && this.isTamed() &&  ((EntityVelociraptor) p_70878_1_).isTamed()){
            	return true;
            }
        ...
        else if (!(p_70878_1_ instanceof EntityVelociraptor))
        {
            return false;
        }
        ...
        {
            EntityVelociraptor entitywolf = (EntityVelociraptor)p_70878_1_;
    ...
    public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        ...
        {
            if (p_142018_1_ instanceof EntityVelociraptor)
            {
                EntityVelociraptor entitywolf = (EntityVelociraptor)p_142018_1_;
