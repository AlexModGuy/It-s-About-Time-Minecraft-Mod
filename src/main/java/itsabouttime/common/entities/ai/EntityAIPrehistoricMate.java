...
public class EntityAIPrehistoricMate extends EntityAIBase
{
    private EntityPehistoricAnimal theAnimal;
    World theWorld;
    private EntityPehistoricAnimal targetMate;
    /**
    ...
    public EntityAIPrehistoricMate(EntityPehistoricAnimal p_i1619_1_, double p_i1619_2_)
    {
     ...
     * valid mate found.
     */
    private EntityPehistoricAnimal getNearbyMate()
    {
        float f = 8.0F;
        ...
        EntityPehistoricAnimal EntityPehistoricAnimal = null;
        Iterator iterator = list.iterator();

        while (iterator.hasNext())
        {
            EntityPehistoricAnimal EntityPehistoricAnimal1 = (EntityPehistoricAnimal)iterator.next();

            if (this.theAnimal.canMateWith(EntityPehistoricAnimal1) && this.theAnimal.getDistanceSqToEntity(EntityPehistoricAnimal1) < d0)
            {
                EntityPehistoricAnimal = EntityPehistoricAnimal1;
                d0 = this.theAnimal.getDistanceSqToEntity(EntityPehistoricAnimal1);
            }
        }

        return EntityPehistoricAnimal;
    }
