...
public class EntityAIPrehistoricCompyBeg extends EntityAIBase
{
    private EntityCompy theWolf;
    ...
    public EntityAIPrehistoricCompyBeg(EntityCompy p_i1617_1_, float p_i1617_2_)
    {
