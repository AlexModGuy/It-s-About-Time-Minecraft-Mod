...
public class EntityAIPrehistoricBeg extends EntityAIBase
{
    private EntityVelociraptor theWolf;
    ...
    public EntityAIPrehistoricBeg(EntityVelociraptor p_i1617_1_, float p_i1617_2_)
    {
