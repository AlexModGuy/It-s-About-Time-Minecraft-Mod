...
public class EntityAICompyWatchClosest extends EntityAIBase
{
    private EntityCompy theWatcher;
    ...
    public EntityAICompyWatchClosest(EntityCompy p_i1631_1_, Class p_i1631_2_, float p_i1631_3_)
    {
    ...
    public EntityAICompyWatchClosest(EntityCompy p_i1632_1_, Class p_i1632_2_, float p_i1632_3_, float p_i1632_4_)
    {
