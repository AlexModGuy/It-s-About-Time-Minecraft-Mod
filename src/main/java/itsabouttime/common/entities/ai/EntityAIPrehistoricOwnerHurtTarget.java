...
public class EntityAIPrehistoricOwnerHurtTarget extends EntityAITarget
{
    EntityTamablePrehistoric theDefendingTameable;
    EntityLivingBase theOwnerAttacker;
    private int field_142051_e;
    private static final String __OBFID = "CL_00001624";

    public EntityAIPrehistoricOwnerHurtTarget(EntityTamablePrehistoric p_i1667_1_)
    {
