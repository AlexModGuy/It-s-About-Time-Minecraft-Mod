...
public class EntityAIPrehistoricMobMate extends EntityAIBase
{
    private EntityPrehistoricMob theAnimal;
    World theWorld;
    private EntityPrehistoricMob targetMate;
    /**
    ...
    public EntityAIPrehistoricMobMate(EntityPrehistoricMob p_i1619_1_, double p_i1619_2_)
    {
     ...
     * valid mate found.
     */
    private EntityPrehistoricMob getNearbyMate()
    {
        float f = 8.0F;
        ...
        EntityPrehistoricMob EntityPrehistoricMob = null;
        Iterator iterator = list.iterator();

        while (iterator.hasNext())
        {
            EntityPrehistoricMob EntityPrehistoricMob1 = (EntityPrehistoricMob)iterator.next();

            if (this.theAnimal.canMateWith(EntityPrehistoricMob1) && this.theAnimal.getDistanceSqToEntity(EntityPrehistoricMob1) < d0)
            {
                EntityPrehistoricMob = EntityPrehistoricMob1;
                d0 = this.theAnimal.getDistanceSqToEntity(EntityPrehistoricMob1);
            }
        }

        return EntityPrehistoricMob;
    }
