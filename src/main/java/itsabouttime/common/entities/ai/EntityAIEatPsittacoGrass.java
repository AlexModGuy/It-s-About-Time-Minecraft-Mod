...
public class EntityAIEatPsittacoGrass extends AIAnimation
{
    ...
    public EntityAIEatPsittacoGrass(EntityLiving p_i45314_1_, IAnimatedEntity entity)
    {
		super(entity);
    ...
    public void updateTask()
    {
        ...
        if (this.field_151502_a == 4)
        {
            ...
            else if (this.field_151501_c.getBlock(i, j - 1, k) == Blocks.grass||this.field_151501_c.getBlock(i, j - 1, k) == IATstuff.PrehistoricPodzol||this.field_151501_c.getBlock(i, j - 1, k) == IATstuff.LushPodzol)
            {
                if (this.field_151501_c.getGameRules().getGameRuleBooleanValue("mobGriefing"))
                {
