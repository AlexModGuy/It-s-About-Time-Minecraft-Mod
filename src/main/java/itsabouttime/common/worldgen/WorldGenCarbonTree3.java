...
public class WorldGenCarbonTree3 extends WorldGenAbstractTree
{
    private Block wood;
  ...
  //  private final int minTreeHeight;
   // private final int randomTreeHeight;
    ...
    public WorldGenCarbonTree3(Block wood,Block leaves, int Leafmeta, int meta, Block... i) 
    {
        super(false);
...
//TopLeaves
               ...
               world.setBlock(x + 2, y+height-1, z, wood, meta, 2);
               world.setBlock(x - 2, y+height-1, z, wood, meta, 2);


               world.setBlock(x + 2, y+height, z, wood, meta, 2);
               world.setBlock(x + 2, y+height+1, z, wood, meta, 2);
               world.setBlock(x + 2, y+height+2, z, wood, meta, 2);
               world.setBlock(x + 3, y+height+2, z, wood, meta, 2);
               world.setBlock(x + 3, y+height+3, z, wood, meta, 2);
               world.setBlock(x + 4, y+height+3, z, wood, meta, 2);
               world.setBlock(x + 4, y+height+4, z, wood, meta, 2);
               ...
               //Right Arm
               world.setBlock(x + 4, y+height+6, z, leaves, meta, 2);
               world.setBlock(x + 4, y+height+5, z, wood, meta, 2);
               world.setBlock(x + 4, y+height+4, z, wood, meta, 2);
               world.setBlock(x + 4, y+height+3, z, wood, meta, 2);

               world.setBlock(x + 4, y+height+5, z+1, leaves, meta, 2);
               world.setBlock(x + 4, y+height+4, z+1, leaves, meta, 2);
               world.setBlock(x + 4, y+height+3, z+1, leaves, meta, 2);
               
               world.setBlock(x + 4, y+height+5, z-1, leaves, meta, 2);
               world.setBlock(x + 4, y+height+4, z-1, leaves, meta, 2);
               world.setBlock(x + 4, y+height+3, z-1, leaves, meta, 2);
               
               world.setBlock(x+5, y+height+3, z, leaves, meta, 2);
               world.setBlock(x+4, y+height+2, z, leaves, meta, 2);
               
               world.setBlock(x+3, y+height+4, z, leaves, meta, 2);
               world.setBlock(x+3, y+height+5, z, leaves, meta, 2);
               
               world.setBlock(x+5, y+height+4, z, leaves, meta, 2);
               world.setBlock(x+5, y+height+5, z, leaves, meta, 2);
               //LeftArm  
